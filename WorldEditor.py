...
class WorldBuilderApplication(tk.Frame):
    ...
    def setup_world(self):
        load_existing = messagebox.askyesno("World Selection",
    ...
    def load_world(self, init=False):
        filename = askopenfilename(initialdir="./worlds", title="Select Karel World",
                                   filetypes=[("Karel Worlds", "*.w")], parent=self.master)
    ...
    def create_canvas(self):
		...
		world are drawn. 
		"""
        self.canvas = KarelCanvas(self.canvas_width, self.canvas_height, self.master, world=self.world,
                                  karel=self.karel)
    ...
    def create_direction_radio_buttons(self):
        ...
        tk.Radiobutton(self.dir_radio_frame, text="E", variable=self.karel_direction_var, value="east",
                       bg=LIGHT_GREY).pack(side="left")
        tk.Radiobutton(self.dir_radio_frame, text="W", variable=self.karel_direction_var, value="west",
                       bg=LIGHT_GREY).pack(side="left")
        tk.Radiobutton(self.dir_radio_frame, text="N", variable=self.karel_direction_var, value="north",
                       bg=LIGHT_GREY).pack(side="left")
        tk.Radiobutton(self.dir_radio_frame, text="S", variable=self.karel_direction_var, value="south",
                       bg=LIGHT_GREY).pack(side="left")
    ...
    def create_beeper_bag_radio_buttons(self):
        ...
        tk.Radiobutton(self.beeper_bag_radio_frame, text="Empty", variable=self.beeper_bag_var, value=0,
                       bg=LIGHT_GREY).pack(side="left")
        tk.Radiobutton(self.beeper_bag_radio_frame, text="INFINITY", variable=self.beeper_bag_var, value=INFINITY,
                       bg=LIGHT_GREY).pack(side="left")
    ...
    def create_action_radio_buttons(self):
        ...
        tk.Radiobutton(self.action_radio_frame, text="Move Karel", variable=self.action_var, value="move_karel",
                       bg=LIGHT_GREY).pack(anchor='w')
        tk.Radiobutton(self.action_radio_frame, text="Add Wall", variable=self.action_var, value="add_wall",
                       bg=LIGHT_GREY).pack(anchor='w')
        tk.Radiobutton(self.action_radio_frame, text="Remove Wall", variable=self.action_var, value="remove_wall",
                       bg=LIGHT_GREY).pack(anchor='w')
        tk.Radiobutton(self.action_radio_frame, text="Add Beeper", variable=self.action_var, value="add_beeper",
                       bg=LIGHT_GREY).pack(anchor='w')
        tk.Radiobutton(self.action_radio_frame, text="Remove Beeper", variable=self.action_var, value="remove_beeper",
                       bg=LIGHT_GREY).pack(anchor='w')
        ...
        tk.Radiobutton(color_selection_frame, text="Paint Corner", variable=self.action_var, value="paint_corner",
                       bg=LIGHT_GREY).pack(side='left')
        ...
        tk.Radiobutton(self.action_radio_frame, text="Reset Corner", variable=self.action_var, value="reset_corner",
                       bg=LIGHT_GREY).pack(anchor='w')
    ...
    def save_world(self):
        filename = asksaveasfilename(initialdir="./worlds", title="Save Karel World",
                                     filetypes=[("Karel Worlds", "*.w")], parent=self.master)
        if filename == "": return
