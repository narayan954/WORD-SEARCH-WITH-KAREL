...
class KarelCanvas(tk.Canvas):
    ...
    def draw_beeper(self, location, count):
        ...
        points = [corner_x, corner_y - beeper_radius, corner_x + beeper_radius, corner_y, corner_x,
                  corner_y + beeper_radius, corner_x - beeper_radius, corner_y]
        self.create_polygon(points, fill="light grey", outline="black", tag="beeper")

        if count > 1:
            self.create_text(corner_x, corner_y, text=str(count), font="Arial 8", tag="beeper")
    ...
    def generate_internal_karel_points(self, x, y, center, direction):
        ...
        inner_points = [inner_x, inner_y, inner_x + inner_width, inner_y, inner_x + inner_width, inner_y + inner_height,
                        inner_x, inner_y + inner_height, inner_x, inner_y]
